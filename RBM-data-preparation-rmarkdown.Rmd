...
Date: Last revision was on March 2024 
...
2. **Merge individual and household level datasets**
   ...
   + Main household dataset doesn’t have the demographic indicators (while the respondent information for randomly selected adult can be found within individual dataset) – merge these variables with the main dataset to be able to disaggregate by household characteristics.
